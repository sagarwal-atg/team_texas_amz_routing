    ...
    for epoch_idx in range(config.num_train_epochs):
        ...
        for idx, data in enumerate(dataloader):
            ...
            if idx % config.batch_size == config.batch_size - 1:
                ...
                demo_cost = 1 * batch_demo_time_cost + theta.dot(
                    batch_demo_feature_cost.T
                )
                pred_cost = 1 * batch_pred_time_cost + theta.dot(
                ...
                writer.add_scalar(
                    "Train/batch_route_loss", loss, epoch_idx * len(dataloader) + idx
                )
                writer.add_scalar(
                ...
                print(
                    "Epoch: {}, Step: {}, Loss: {:01f}, Score: {:01f}, Time: {}, Theta: {}, Lambda: {}".format(
                        epoch_idx,
